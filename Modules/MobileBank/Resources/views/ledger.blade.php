        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-5">
                ...
                <div class="card-toolbar">
                    ...
                    <a href="{{ route('mobilebank') }}" class="btn btn-primary btn-sm font-weight-bolder ml-3"> 
                        <i class="fas fa-university"></i> Manage Mobile Bank</a>
                    @endif
                    @if (permission('mobile-bank-transaction-access'))
                    <a href="{{ route('mobilebank.transaction') }}" class="btn btn-primary btn-sm font-weight-bolder ml-3"> 
                        <i class="far fa-money-bill-alt"></i> Mobile Bank Transaction</a>
                    @endif
                    <!--end::Button-->
                </div>
            </div>
            ...
            <div class="card-header flex-wrap py-5">
                <form method="POST" id="form-filter" class="col-md-12 px-0">
                    <div class="row">
                        ...
                        <x-form.selectbox labelName="Mobile Bank Name" name="bank_name" required="required" col="col-md-3" class="selectpicker">
                            @if (!$banks->isEmpty())
...
$(document).ready(function(){
    ...
    $(document).on('click','#btn-filter',function(){
        ...
        {
            $.ajax({
                url: "{{route('mobilebank.ledger.data')}}",
                type: "POST",
            ...
            notification('error','Please select mobile bank');
        }
    });
