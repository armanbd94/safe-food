                                    ...
                                    <tr>
                                        <td width="40%">
                                            <table>
                                                <tr>
                                                    ...
                                                    <td><b>: {{ $damage->sale->dealer->name }}</b></td>
                                                </tr>
                                                <tr>
                                                    <td><b>Mobile No.</b></td>
                                                    <td><b>: </b>{{ $damage->sale->dealer->mobile_no }}</td>
                                                </tr>
                                                <tr>
                                                    <td><b>Area Name</b></td>
                                                    <td><b>: </b> {{ $damage->sale->area->name.', '.$damage->sale->district->name }}</td>
                                                </tr>

                                                @if($damage->sale->dealer->address)
                                                <tr>
                                                    <td><b>Address</b></td>
                                                    <td><b>: </b>{{ $damage->sale->dealer->address }}</td>
                                                </tr>
                                                @endif
                                            </table>
                                        </td>
                                        ...
                                        <td width="40%">
                                            <table>
                                                <tr>
                                                    <td><b>Damage No.</b></td>
                                                    <td><b>: #{{ $damage->damage_no }}</b></td>
                                                </tr>
                                                <tr>
                                                    <td><b>Memo No.</b></td>
                                                    <td><b>: #{{ $damage->sale->memo_no }}</b></td>
                                                </tr>
                                                <tr>
                                                    <td><b>Damage Date</b></td>
                                                    <td><b>: </b> {{ date('d-M-Y',strtotime($damage->damage_date)) }}</td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                                ...
                                <table cellspacing="0" cellpadding="0" id="product_table">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td  class="text-center font-weight-bolder">DAMAGE QTY</td>
                                        ...
                                        @if (!$damage->damage_products->isEmpty())
                                            @foreach ($damage->damage_products as $key => $item)
                                                <tr>
                                                    ...
                                                    <td class="text-center">{{ $item->pivot->damage_qty }}</td>
                                    ...
                                    <tfoot>
                                        ...
                                        <tr>
                                            <td class="text-right font-weight-bolder" style="padding-right: 5px;">TOTAL DAMAGE AMOUNT</td>
                                            <td class="text-right font-weight-bolder" style="padding-right: 5px;">{{ number_format($damage->grand_total,2,'.',',') }} </td>
                                        </tr>
                                    </tfoot>
                                </table>
                            </div>
