        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-5">
                ...
                <div class="card-toolbar">
                    ...
                    <a href="{{ route('contra.voucher.create') }}"  class="btn btn-primary btn-sm font-weight-bolder"> 
...
@include('account::contra-voucher.view-modal')
@endsection
...
$(document).ready(function(){
    ...
    table = $('#dataTable').DataTable({
        ...
        "ajax": {
            "url": "{{route('contra.voucher.datatable.data')}}",
            "type": "POST",
            "data": function (data) {
