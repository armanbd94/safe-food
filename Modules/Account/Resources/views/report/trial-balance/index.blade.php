            ...
            <div class="card-header flex-wrap py-5">
                <form method="POST" id="form-filter" class="col-md-12 px-0">
                    <div class="row">
                        ...
                        <x-form.selectbox labelName="With Details" name="with_details"  col="col-md-3" class="selectpicker">
...
function report()
{
    ...
    var with_details = $('#with_details option:selected').val();

    $.ajax({
        url:"{{ url('trial-balance/report') }}",
        type:"POST",
        data:{start_date:start_date,end_date:end_date,with_details:with_details,_token:_token},
