...
function report()
{
    ...
    var bank_name = $('#bank_acc_id option:selected').data('name');

if(bank_acc_id){
    $.ajax({
        url:"{{ url('mobile-bank-book/report') }}",
        type:"POST",
        data:{start_date:start_date,end_date:end_date,bank_acc_id:bank_acc_id,bank_name:bank_name,_token:_token},
