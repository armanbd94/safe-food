        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-5">
                ...
                <div class="card-toolbar">
                    ...
                    <a href="{{ url('dealer-receive') }}" class="btn btn-warning btn-sm font-weight-bolder"> 
                            ...
                            <div class="card-body">
                                <div id="printableArea" style="width: 100%;margin:0;padding:0;">
                                    ...
                                    <table class="table table-borderless" style="width:100%;" id="invoice-table" border="0">
                                        ...
                                        <tr>
                                            <td width="25%"><b>Dealer Name</b></td><td width="5%"><b>:</b></td><td width="70%" class="text-left">{{ $data->coa->dealer->name }}</td>
                                        </tr>
                                        <tr>
                                            <td width="25%"><b>Payment Type</b></td width="5%"><td><b>:</b></td><td width="70%" class="text-left">{{ SALE_PAYMENT_METHOD[$payment_type] }}</td>
                                        </tr>
                                        <tr>
                                            <td width="25%"><b>Amount</b></td><td width="5%"><b>:</b></td><td width="70%" class="text-left">{{ number_format($data->credit,2,'.',',') }}Tk</td>
                                        </tr>
                                        <tr>
