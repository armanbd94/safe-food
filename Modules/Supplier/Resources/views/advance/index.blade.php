            ...
            <div class="card-header flex-wrap py-5">
                <form method="POST" id="form-filter" class="col-md-12 px-0">
                    <div class="row">
                        ...
                        <x-form.selectbox labelName="Supplier Name" name="supplier_id" col="col-md-4" class="selectpicker">
...
$(document).ready(function(){
    ...
    $(document).on('click', '#save-btn', function () {
        ...
        $.ajax({
            url: url,
            type: "POST",
            data: {id:id,supplier:supplier,supplier_coaid:supplier_coaid,supplier_name:supplier_name,amount:amount,
                payment_method:payment_method,account_id:account_id,reference_number:reference_number,_token:_token},
            dataType: "JSON",
            beforeSend: function(){
