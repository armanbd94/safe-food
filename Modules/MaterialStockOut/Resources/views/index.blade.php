        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-5">
                ...
                <div class="card-toolbar">
                    ...
                    <a href="{{ route('material.stock.out.create') }}"  class="btn btn-primary btn-sm font-weight-bolder"> 
        ...
        <div class="card card-custom">
            <div class="card-header flex-wrap py-5">
                <form method="POST" id="form-filter" class="col-md-12 px-0">
                    <div class="row">
                        <x-form.textbox labelName="Stock Out No." name="stock_out_no" col="col-md-3" />
...
<script>
    ...
    $(document).ready(function(){
        ...
        table = $('#dataTable').DataTable({
            ...
            "ajax": {
                "url": "{{route('material.stock.out.datatable.data')}}",
                "type": "POST",
                "data": function (data) {
                    data.stock_out_no   = $("#form-filter #stock_out_no").val();
        ...
        $(document).on('click', '.delete_data', function () {
            ...
            let url   = "{{ route('material.stock.out.delete') }}";
        ...
        function multi_delete(){
            ...
            if(ids.length == 0){
                ...
                let url = "{{route('material.stock.out.bulk.delete')}}";
