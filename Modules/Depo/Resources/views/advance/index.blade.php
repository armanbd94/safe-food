        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-5">
                ...
                <div class="card-toolbar">
                    <!--begin::Button-->
                    @if (permission('depo-advance-add'))
                    <a href="javascript:void(0);" onclick="showAdvanceFormModal('Add New Depo Advance','Save')" class="btn btn-primary btn-sm font-weight-bolder"> 
            ...
            <div class="card-header flex-wrap py-5">
                <form method="POST" id="form-filter" class="col-md-12 px-0">
                    <div class="row">
                        ...
                        <x-form.selectbox labelName="Depo" name="depo_id" col="col-md-4" class="selectpicker" onchange="getUpazilaList(this.value,1)" >
                            @if (!$depos->isEmpty())
...
$(document).ready(function(){
    ...
    table = $('#dataTable').DataTable({
        ...
        "ajax": {
            "url": "{{route('depo.advance.datatable.data')}}",
            "type": "POST",
            "data": function (data) {
    ...
    $(document).on('click', '#save-btn', function () {
        var depo       = $('#store_or_update_form #depo option:selected').val();
        var depo_coaid = $('#store_or_update_form #depo option:selected').data('coaid');
        var depo_name  = $('#store_or_update_form #depo option:selected').data('name');
        ...
        let url = "{{route('depo.advance.store.or.update')}}";
        ...
        $.ajax({
            url: url,
            type: "POST",
            data: {id:id,depo:depo,depo_coaid:depo_coaid,depo_name:depo_name,amount:amount,
            ...
            $.ajax({
                ...
                success: function (data) {
                    if(data.status == 'error'){
                        ...
                        $('#store_or_update_form #depo').val(data.depo_id);
    ...
    $(document).on('click', '.delete_data', function () {
        ...
        let url   = "{{ route('depo.advance.delete') }}";
