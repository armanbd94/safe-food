        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-5">
                ...
                <div class="card-toolbar">
                    ...
                    <a href="{{ route('guest.gift.add') }}"  class="btn btn-primary btn-sm font-weight-bolder"> 
...
$(document).ready(function(){
    ...
    table = $('#dataTable').DataTable({
        ...
        "ajax": {
            "url": "{{route('guest.gift.datatable.data')}}",
            "type": "POST",
            "data": function (data) {
                data.voucher_name    = $("#form-filter #voucher_name").val();
    ...
    $(document).on('click', '.delete_data', function () {
        ...
        let url   = "{{ route('guest.gift.delete') }}";
    ...
    function multi_delete(){
        ...
        if(ids.length == 0){
            ...
            let url = "{{route('guest.gift.bulk.delete')}}";
