                ...
                <div class="col-md-12 col-lg-12"  style="width: 100%;">
                    <div id="invoice">
                        ...
                        <div class="invoice overflow-auto">
                            ...
                            font-weight: bold;background: black;border-radius: 10px;width: 200px;color: white;text-align: center;padding:5px 0;}">GIFT VOUCHER</p>
                                        </td>
                                    </tr>
                                </table>
                                        ...
                                        <td width="40%">
                                            <table>
                                                <tr>
                                                    ...
                                                    <td><b>: {{ $gift->guest_name }}</b></td>
                                                </tr>
                                                <tr>
                                                    <td><b>Gift From</b></td>
                                                    <td><b>: </b>{{ $gift->gift_from }}</td>
                                                </tr>
                                            </table>
                                        </td>
                                        <td width="20%"></td>
                                        <td width="40%">
                                            <table>
                                                <tr>
                                                    ...
                                                    <td><b>: #{{ $gift->voucher_no }}</b></td>
                                                </tr>
                                                <tr>
                                                    <td><b>Date</b></td>
                                                    <td><b>: </b> {{ date('d-M-Y',strtotime($gift->date)) }}</td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                                ...
                                <table cellspacing="0" cellpadding="0" id="product_table">
                                    <tbody>
                                        ...
                                        @endif
                                        <tr>
                                            <td class="text-left  pl-3 font-weight-bolder" colspan="2">TOTAL</td>
                                            <td class="text-center  font-weight-bolder">{{ number_format($gift->total_qty,2,'.',',') }}</td>
                                            <td class=""></td>
                                        </tr>
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            <div class="font-size-10" style="width:250px;float:right;padding-top:50px;">
                                                <p style="margin:0;padding:0;">{{ $gift->created_by }}<br>{{ date('d-M-Y h:i:sA',strtotime($gift->created_at)) }}</p>
                                                <p class="dashed-border"></p>
                                                <p style="margin:0;padding:0;text-transform: capitalize;font-weight:normal;">Generated By</p>
                                            </div>
                                        </td>
                                    </tr>
                                </table>
