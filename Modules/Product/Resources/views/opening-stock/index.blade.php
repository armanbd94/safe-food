        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-5">
                ...
                <div class="card-toolbar">
                    ...
                    <a href="{{ route('opening.stock.add') }}"  class="btn btn-primary btn-sm font-weight-bolder"> 
        ...
        <div class="card card-custom">
            <div class="card-header flex-wrap py-5">
                <form method="POST" id="form-filter" class="col-md-12 px-0">
                    <div class="row">
                        <x-form.textbox labelName="Opening No." name="opening_no" col="col-md-3" />
...
<script>
    ...
    $(document).ready(function(){
        ...
        table = $('#dataTable').DataTable({
            ...
            "ajax": {
                "url": "{{route('opening.stock.datatable.data')}}",
                "type": "POST",
                "data": function (data) {
                    data.opening_no   = $("#form-filter #opening_no").val();
            ...
            "buttons": [
                @if (permission('opening-stock-report'))
                {
        ...
        $(document).on('click', '.delete_data', function () {
            ...
            let url   = "{{ route('opening.stock.delete') }}";
        ...
        function multi_delete(){
            ...
            if(ids.length == 0){
                ...
                let url = "{{route('opening.stock.bulk.delete')}}";
