            ...
            <div class="card-header flex-wrap py-5">
                <form method="POST" id="form-filter" class="col-md-12 px-0">
                    <div class="row">
                        ...
                        <x-form.selectbox labelName="Upazila" name="parent_id" col="col-md-4" class="selectpicker">
                            @if (!$upazilas->isEmpty())
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if(data.status == 'error'){
                            ...
                            $('#store_or_update_form #grand_parent_id').val(data.grand_parent_id);
                            $('#store_or_update_form .selectpicker').selectpicker('refresh');
                            getUpazilaList(data.grand_parent_id,2,data.parent_id);
    ...
    function getUpazilaList(district_id,set_id,upazila_id='')
    {
        $.ajax({
            ...
            success:function(data){
                ...
                if(set_id == 1)
                {
                    $('#form-filter #parent_id').empty();
                    $('#form-filter #parent_id').append(html);
                }else{
                ...
                if(upazila_id){
                    $('#store_or_update_form #parent_id').val(upazila_id);
