            ...
            <div class="card-header flex-wrap py-5">
                <form method="POST" id="form-filter" class="col-md-12 px-0">
                    <div class="row">
                        ...
                        <x-form.selectbox labelName="Expense Type" name="expense_item_id" col="col-md-3" class="selectpicker">
...
$(document).ready(function(){
    ...
    table = $('#dataTable').DataTable({
        ...
        "ajax": {
            "url": "{{route('warehouse.expense.report.datatable.data')}}",
            "type": "POST",
            "data": function (data) {
                data.warehouse_id    = $("#form-filter #warehouse_id").val();
                data.expense_item_id = $("#form-filter #expense_item_id").val();
    ...
    $('#btn-reset').click(function () {
        $('#form-filter')[0].reset();
        $('#start_date,#end_date,#expense_item_id,#warehouse_id').val("");
