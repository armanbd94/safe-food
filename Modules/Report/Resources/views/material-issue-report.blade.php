            ...
            <div class="card-header flex-wrap py-5">
                <form method="POST" id="form-filter" class="col-md-12 px-0">
                    <div class="row">
                        ...
                        <x-form.selectbox labelName="Material" name="material_id" col="col-md-4" required="required" class="selectpicker">
                            @if (!$materials->isEmpty())
                            @foreach ($materials as $value)
                                <option value="{{ $value->id }}">{{ $value->material_code.' - '.$value->material_name }}</option>
                            @endforeach
                            @endif
                        </x-form.selectbox>
...
$(document).ready(function(){
    ...
    table = $('#dataTable').DataTable({
        ...
        "ajax": {
            "url": "{{route('material.issue.report.datatable.data')}}",
            "type": "POST",
            "data": function (data) {
    ...
    $('#btn-reset').click(function () {
        $('#form-filter')[0].reset();
        $('#product_name,#product_id,#start_date,#end_date,#material_id').val('');
