                ...
                <table style="margin-bottom:10px !important;">
                    <tr>
                        <td class="text-center">
                            ...
                            font-weight: bold;background: black;border-radius: 10px;width: 300px;color: white;text-align: center;padding:5px 0;}">DEPO WISE SALES REPORT</p>
                ...
                <table cellspacing="0" cellpadding="0" id="product_table">
                    <tbody>
                        <tr>
                            ...
                            <td class="text-center font-weight-bolder">Sale Date</td>
                            <td class="text-center font-weight-bolder">Items</td>
                            <td class="text-center font-weight-bolder">Total Qty</td>
                            <td class="text-right font-weight-bolder">Grand Total</td>
                            <td class="text-right font-weight-bolder">Commission Rate(%)</td>
                            <td class="text-right font-weight-bolder">Total Commission</td>
                        ...
                        <tr>
                            ...
                            <td class="text-center"> {{ number_format($value->total_item,2,'.',',') }} </td>
                            <td class="text-center"> {{ number_format($value->total_qty,2,'.',',') }} </td>
                            <td class="text-right"> {{ number_format($value->grand_total,2,'.',',') }} </td>
                            <td class="text-right"> {{ number_format($value->commission_rate,2,'.',',') }} </td>
