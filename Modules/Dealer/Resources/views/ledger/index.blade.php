        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-5">
                ...
                <div class="card-toolbar">
                    ...
                    <a href="{{ route('dealer') }}" class="btn btn-primary btn-sm font-weight-bolder mr-3"> 
                        <i class="fas fa-user-secret"></i> Manage Dealer</a>
                    @endif
                    <!--end::Button-->
                </div>
            </div>
                    ...
                    <div class="row justify-content-center">
                        <x-form.selectbox labelName="Dealer" name="dealer_id" col="col-md-3" class="selectpicker">
                            ...
                            @foreach ($dealers as $dealer)
                                <option value="{{ $dealer->id }}">{{ $dealer->name.' - '.$dealer->mobile_no }}</option>
                            @endforeach
                            @endif
                        </x-form.selectbox>
