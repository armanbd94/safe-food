                ...
                <form method="POST" id="form-filter" class="col-md-12 px-0">
                    <div class="row justify-content-center">
                        ...
                        <x-form.selectbox labelName="Material" name="material_id" col="col-md-4" class="selectpicker">
                            ...
                            @foreach ($materials as $id => $material_name)
                                <option value="{{ $id }}">{{ $material_name }}</option>
                            @endforeach
                            @endif
                        </x-form.selectbox>
                        <div class="col-md-4">    
                            <div style="margin-top:28px;">    
                                ...
                                data-toggle="tooltip" data-theme="dark" title="Search" onclick="loadReportData()">
...
function loadReportData()
{
    ...
    $.ajax({
        ...
        type: "POST",
        data: {material_id:$('#material_id option:selected').val(),category_id:$('#category_id option:selected').val(),_token:_token},
        beforeSend: function(){
